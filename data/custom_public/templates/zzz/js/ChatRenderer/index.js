...
function(_, constants, TextMessage, PaidMessage, MembershipItem, Ticker) {
  ...
  exports.default = {
    template: `
  <zzz-live-chat-renderer class="style-scope zzz-live-chat-app" style="--scrollbar-width:11px;" hide-timestamps>
    <ticker class="style-scope zzz-live-chat-renderer" :messages.sync="paidMessages" :showGiftName="showGiftName"></ticker>
    <zzz-live-chat-item-list-renderer class="style-scope zzz-live-chat-renderer" allow-scroll>
      <div ref="scroller" id="item-scroller" class="style-scope zzz-live-chat-item-list-renderer animated">
        <div ref="itemOffset" id="item-offset" class="style-scope zzz-live-chat-item-list-renderer">
          <div ref="items" id="items" class="style-scope zzz-live-chat-item-list-renderer" style="overflow: hidden"
          ...
          >
            <template v-for="message in messages">
              <text-message :key="message.id" v-if="message.type === MESSAGE_TYPE_TEXT"
                class="style-scope zzz-live-chat-item-list-renderer"
                :time="message.time"
    ...
    </zzz-live-chat-item-list-renderer>
  </zzz-live-chat-renderer>
    `,
    name: 'ChatRenderer',
    components: {
      Ticker,
