...
function(constants) {
  ...
  exports.default = {
    template: `
  <nc-live-chat-author-badge-renderer :type="authorTypeText">
    <span :title="readableAuthorTypeText">
      <div id="image">
        <svg v-if="isAdmin" viewBox="0 0 16 16" preserveAspectRatio="xMidYMid meet" focusable="false"
  ...
  </nc-live-chat-author-badge-renderer>
    `,
    name: 'AuthorBadge',
    props: {
      isAdmin: Boolean,
